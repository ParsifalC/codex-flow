...
宠物会自己活动，不需要运行任务或触发特殊 hooks。启动约 4 秒后开始第一段小动作；日常场景之间通常休息 20–35 秒。每段动作完整播放后收尾，九套动画都会自然出现。

| 动作 | 日常播放方式 |
| --- | --- |
| 平时待着 `idle` | 播一轮后回到自然站姿，停留 3–6 秒，再眨眼或轻动一下 |
...
日常的一段场景只表达一件事：跳跃后休息，张望也不一定接低落。场景轮换避免紧接着重复。噜噜的落地、转向更舒缓；Noir Webling 的自主动作出现得稍少。其他导入的宠物使用通用节奏。
